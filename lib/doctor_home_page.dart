  ...
  void _open(BuildContext context, String title) {
    switch (title) {
      ...
      case "Medical Reports":
        ...
        return;
      case "VR Appointments":
        Navigator.push(
          context,
          MaterialPageRoute(builder: (_) => const VrUpcomingAppointmentsPage()),
        );
        return;
      case "Notifications": // ✅ يفتح صفحة التنبيهات ويصفّر الشارة بعد الرجوع
        Navigator.push(
          context,
        ...
        child: ListView(
          ...
          children: [
            ...
            _ServiceChipImage(
              ...
              onTap: () => _open(context, "Medical Reports"),
            ),
            _ServiceChipImage(
              label: "My Quiz Score",
            ...
            _ServiceChipImage(
              label: "VR Appointments",
              image: "assets/images/appointments.jpg",
              onTap: () => _open(context, "VR Appointments"),
            ),
            _ServiceChipImage(
              label: "Contact Us",
              image: "assets/images/appointments.jpg",
