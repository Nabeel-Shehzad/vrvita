    ...
    switch (title) {
      ...
      case "Quiz Score":
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (_) => const QuizScorePage(role: UserRole.nurse),
          ),
        );
        return;
      case "Contact Us":
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (_) => const ContactUsPage(role: UserRole.nurse),
          ),
        );
        return;
      ...
      case "Training Library & Resources":
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (_) => const TrainingLibraryPage(role: UserRole.nurse),
          ),
        );
        return;
      case "Notifications":
