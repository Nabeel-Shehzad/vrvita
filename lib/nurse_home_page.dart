  ...
  void _open(BuildContext context, String title) {
    switch (title) {
      ...
      case "Quiz":
        ...
        return;
      case "Quiz Score":
        Navigator.push(context, MaterialPageRoute(builder: (_) => const QuizScorePage(role: UserRole.nurse)));
        return;
      case "Contact Us":
        Navigator.push(context, MaterialPageRoute(builder: (_) => const ContactUsPage(role: UserRole.nurse)));
        return;
      case "Shifts / Training Sessions":
        Navigator.push(
          context,
      ...
      case "Training Library & Resources":
        Navigator.push(
          context,
          MaterialPageRoute(builder: (_) => const TrainingLibraryPage(role: UserRole.nurse)),
        );
        return;
      case "Notifications":
        Navigator.push(
        ...
        child: ListView(
          ...
          children: [
            _TopBrandBar(
              ...
              onBell: () => _open(context, "Notifications"),
            ),
            ...
            _ServiceChipImage(
              ...
              onTap: () => _open(context, "Quiz"),
            ),
            _ServiceChipImage(
              label: "Tutorials",
              image: "assets/images/Tutorials.jpg",
              onTap: () => _open(context, "Tutorials"),
            ),
            _ServiceChipImage(
              label: "Shifts / Training Sessions",
              image: "assets/images/appointments.jpg",
              onTap: () => _open(context, "Shifts / Training Sessions"),
            ),
            _ServiceChipImage(
              label: "My Quiz Score",
              image: "assets/images/score.jpg",
              onTap: () => _open(context, "Quiz Score"),
            ),
            _ServiceChipImage(
              label: "Training Library & Resources",
              image: "assets/images/appointments.jpg",
              onTap: () => _open(context, "Training Library & Resources"),
            ),
            _ServiceChipImage(
              label: "Contact Us",
              image: "assets/images/appointments.jpg",
              onTap: () => _open(context, "Contact Us"),
            ),
      ...
      children: [
        ...
        Row(
          children: [
            ...
            const Spacer(),
            // ✅ السماعة تفتح ContactUsPage
            IconButton(
              icon: const Icon(Icons.headset_mic_rounded, color: Colors.black87),
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (_) => const ContactUsPage(role: UserRole.nurse)),
                );
              },
            ),
            Stack(
              ...
              children: [
                IconButton(icon: const Icon(Icons.notifications_rounded, color: Colors.black87), onPressed: onBell),
                if (notifCount > 0)
                  Positioned(
                    right: 10,
                    top: 8,
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text("($org)", maxLines: 1, overflow: TextOverflow.ellipsis,
                    style: const TextStyle(fontSize: 14, fontWeight: FontWeight.w600)),
                Text("Specialization: $spec", maxLines: 1, overflow: TextOverflow.ellipsis,
...
class _ServiceChipImage extends StatelessWidget {
  ...
  const _ServiceChipImage({super.key, required this.label, required this.image, required this.onTap});
...
class _MainDrawer extends StatelessWidget {
  ...
  const _MainDrawer({required this.onOpen, super.key});
